...
/******************************************
This is a Message class which stores general 
infomation for both request and response.
It serves as response here.
 *****************************************/
...
public:
  ...
  //insert re-validation info to header, e.g ETag
  ...
  //get infomation in Cache-Control, e.g max-age
...
/******************************************
This is a Request class which extends Message
class for unique infomation of request.
 *****************************************/
